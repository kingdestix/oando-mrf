...
// MRF Download - for completed requests
router.get('/:id/mrf', authenticate, requestController.downloadMRF);

// Confirm material delivery
router.post('/:id/confirm-delivery', authenticate, requestController.confirmMaterialDelivery);
